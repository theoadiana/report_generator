...
export class TemplateManager {
    ...
    async fetchTemplateList() {
        try {
            const response = await fetch('/vendor/theob/report-generator/src/download.php?action=get_template_list');
    ...
    async loadTemplate(filename, PDFDesigner, updateFormInputsFromTemplate, setPreviewSize, generatePreview) {
        try {
            const response = await fetch(`/vendor/theob/report-generator/src/download.php?action=load_template&filename=${encodeURIComponent(filename)}`);
    ...
    async editTemplate() {
        try {
            ...
            const response = await fetch('/vendor/theob/report-generator/src/download.php?action=edit_template', {
                method: 'POST',
    ...
    async deleteTemplate() {
        try {
            ...
            const response = await fetch(`/vendor/theob/report-generator/src/download.php?action=delete_template&filename=${encodeURIComponent(selectedValue)}`);
            const result = await response.json();
