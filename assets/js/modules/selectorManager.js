export class SelectorManager {
    ...
    register(id) {
      ...
      if (id && !this.selectors[id]) {
        this.selectors[id] = {
          ...
          tagName: 'div' // Untuk elemen yang belum ada, kita asumsikan tagName 'unknown'
        };
      }
    }
    ...
    // Fungsi untuk menghasilkan variabel selector seperti const paperSize = document.getElementById("paperSize")
    generateSelectorVariables() {
      const result = {};
      for (const id in this.selectors) {
